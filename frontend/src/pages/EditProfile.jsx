    ...
    <div style={{ minHeight: '80vh', padding: '2rem', color: '#fff' }}>
      ...
      <div className="disco-card" style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <h1 style={{ fontFamily: "'Bungee', cursive", color: '#ffff00' }}>Edit Profile</h1>
          <button className="disco-button" onClick={() => navigate('/profile')} 
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1.5rem' }}>
          <button className="disco-button" onClick={() => navigate('/profile')} 
            style={{ background: 'rgba(255,255,255,0.2)' }}>Cancel</button>
